...
class Window(wx.Window):
    ...
    def __init__(self, parent):
        ...
        self.colors = {0: (255, 240, 245), 2: (238, 228, 218), 4: (237, 224, 200), 8: (242, 177, 121),
    ...
    # initialize the game-----------------------------------------------------------------------
    def initGame(self):
        self.bgFont = wx.Font(12, wx.FONTFAMILY_SCRIPT, wx.FONTSTYLE_ITALIC, wx.FONTWEIGHT_BOLD, 0, "Comic Sans MS")
        self.scFont = wx.Font(12, wx.FONTFAMILY_SCRIPT, wx.FONTSTYLE_ITALIC, wx.FONTWEIGHT_BOLD, 0, "Comic Sans MS")
        self.smFont = wx.Font(12, wx.FONTFAMILY_SCRIPT, wx.FONTSTYLE_ITALIC, wx.FONTWEIGHT_BOLD, 0, "Comic Sans MS")
        self.curScore = 0
        self.bstScore = 0
        self.loadScore()
...
class Frame(wx.Frame):
    ...
    def setIcon(self):
        icon = wx.Icon("\\Users\eldkt\Downloads\Game-2048-master\icon.ico", wx.BITMAP_TYPE_ICO)
        self.SetIcon(icon)
